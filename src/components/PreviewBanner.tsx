...
export default function PreviewBanner() {
  ...
  // Tint the banner accents to the active theme. accentForDark guards
  // against a near-black accent (Minimal) vanishing on the black bar.
  const tint = accentForDark(active.accent);
      ...
      <div className="max-w-[1340px] mx-auto px-6 sm:px-10 py-2.5 flex items-center justify-between gap-4">
        <div className="flex items-center gap-2.5 min-w-0">
          <span
            ...
            style={{ background: tint, transition: "background-color 600ms ease" }}
          />
        ...
        <div className="hidden sm:flex items-center gap-3 shrink-0">
          ...
          <span style={{ color: tint, transition: "color 600ms ease" }}>
            {active.name}
          </span>
